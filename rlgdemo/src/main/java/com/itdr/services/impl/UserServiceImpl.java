...
//改答案
    ...
    public ServiceResponse<Users> forgetCheckAnswer(String username, String question, String answer) {
        ...
        int num = usersMapper.selectByUsernameAndQuestionAndAnswer(username, question, answer);
        if (num <= 0) {
            return ServiceResponse.defeadetRs("问题答案不匹配");
        }
        ...
        return ServiceResponse.successRs(token);
    }
}
